...
import { validateCivicServiceLocation, SUPPORTED_LOCATIONS_SUMMARY } from '../utils/supportedLocations';
...
export const CIVIC_DEPARTMENTS_CONFIG: CivicDepartmentInfo[] = [
  {
    ...
    officers: [
      { id: 'OFF-001', entry_id: 'OFF-001', username: 'ravi.kumar', name: 'Ravi Kumar', departmentKey: 'roads', departmentName: 'Roads & Infrastructure', city: 'Khammam', area: 'Wyra Road', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 27, processedProjects: 30, status: 'Available', phone: '+91 98765 43201', designation: 'Senior Roads & Infrastructure Engineer', email: 'ravi.kumar@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-002', entry_id: 'OFF-002', username: 'suresh.reddy', name: 'Suresh Reddy', departmentKey: 'roads', departmentName: 'Roads & Infrastructure', city: 'Hyderabad', area: 'Gachibowli', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 30, processedProjects: 32, status: 'Available', phone: '+91 98765 43202', designation: 'Rapid Paving Supervisor', email: 'suresh.reddy@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-003', entry_id: 'OFF-003', username: 'anita.sharma', name: 'Anita Sharma', departmentKey: 'roads', departmentName: 'Roads & Infrastructure', city: 'Warangal', area: 'Subedari', currentAssignments: 4, ongoingProjects: 2, pendingProjects: 2, solvedProjects: 24, processedProjects: 28, status: 'Available', phone: '+91 98765 43203', designation: 'Public Works Inspector', email: 'anita.sharma@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-004', entry_id: 'OFF-004', username: 'dinesh.gupta', name: 'Dinesh Gupta', departmentKey: 'roads', departmentName: 'Roads & Infrastructure', city: 'Vijayawada', area: 'Benz Circle', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 15, processedProjects: 16, status: 'Available', phone: '+91 98765 43204', designation: 'Asphalt & Pavement Specialist', email: 'dinesh.gupta@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-005', entry_id: 'OFF-005', username: 'pooja.varma', name: 'Pooja Varma', departmentKey: 'roads', departmentName: 'Roads & Infrastructure', city: 'Visakhapatnam', area: 'MVP Colony', currentAssignments: 5, ongoingProjects: 3, pendingProjects: 2, solvedProjects: 35, processedProjects: 40, status: 'Busy', phone: '+91 98765 43205', designation: 'Urban Infrastructure Lead', email: 'pooja.varma@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'water',
    name: 'Water Supply',
    description: 'Water pipeline leakage, broken water mains, low pressure, contaminated water supply',
    coverage: ['Water Pipeline Leakage', 'Broken Pipes', 'Low Water Pressure', 'Contaminated Drinking Water'],
    officers: [
      { id: 'OFF-006', entry_id: 'OFF-006', username: 'rajesh.varma', name: 'Rajesh Varma', departmentKey: 'water', departmentName: 'Water Supply', city: 'Khammam', area: 'Kothapet', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 23, processedProjects: 25, status: 'Available', phone: '+91 98765 43206', designation: 'Hydro-Engineering Lead', email: 'rajesh.varma@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-007', entry_id: 'OFF-007', username: 'priya.nair', name: 'Priya Nair', departmentKey: 'water', departmentName: 'Water Supply', city: 'Hyderabad', area: 'Jubilee Hills', currentAssignments: 4, ongoingProjects: 2, pendingProjects: 2, solvedProjects: 21, processedProjects: 25, status: 'Available', phone: '+91 98765 43207', designation: 'Water Distribution Supervisor', email: 'priya.nair@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-008', entry_id: 'OFF-008', username: 'amit.chawla', name: 'Amit Chawla', departmentKey: 'water', departmentName: 'Water Supply', city: 'Warangal', area: 'Kazipet', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 17, processedProjects: 18, status: 'Available', phone: '+91 98765 43208', designation: 'Pipeline Pressure Analyst', email: 'amit.chawla@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-009', entry_id: 'OFF-009', username: 'sneha.pillai', name: 'Sneha Pillai', departmentKey: 'water', departmentName: 'Water Supply', city: 'Vijayawada', area: 'Governorpet', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 25, processedProjects: 28, status: 'Available', phone: '+91 98765 43209', designation: 'Drinking Water Quality Controller', email: 'sneha.pillai@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-010', entry_id: 'OFF-010', username: 'mahesh.babu', name: 'Mahesh Babu', departmentKey: 'water', departmentName: 'Water Supply', city: 'Visakhapatnam', area: 'Gajuwaka', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 19, processedProjects: 21, status: 'Available', phone: '+91 98765 43210', designation: 'Emergency Leakage Squad Lead', email: 'mahesh.babu@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'sanitation',
    ...
    officers: [
      { id: 'OFF-011', entry_id: 'OFF-011', username: 'imran.khan', name: 'Imran Khan', departmentKey: 'sanitation', departmentName: 'Sanitation & Waste Management', city: 'Hyderabad', area: 'Banjara Hills', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 31, processedProjects: 34, status: 'Available', phone: '+91 98765 43211', designation: 'Senior Sanitation Inspector', email: 'imran.khan@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-012', entry_id: 'OFF-012', username: 'kavita.meena', name: 'Kavita Meena', departmentKey: 'sanitation', departmentName: 'Sanitation & Waste Management', city: 'Khammam', area: 'Gandhi Nagar', currentAssignments: 0, ongoingProjects: 0, pendingProjects: 0, solvedProjects: 11, processedProjects: 11, status: 'Available', phone: '+91 98765 43212', designation: 'Waste Logistics Supervisor', email: 'kavita.meena@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-013', entry_id: 'OFF-013', username: 'ramesh.yadav', name: 'Ramesh Yadav', departmentKey: 'sanitation', departmentName: 'Sanitation & Waste Management', city: 'Guntur', area: 'Arundelpet', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 15, processedProjects: 17, status: 'Available', phone: '+91 98765 43213', designation: 'Solid Waste Field Marshal', email: 'ramesh.yadav@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-014', entry_id: 'OFF-014', username: 'sunita.das', name: 'Sunita Das', departmentKey: 'sanitation', departmentName: 'Sanitation & Waste Management', city: 'Tirupati', area: 'Renigunta Road', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 12, processedProjects: 13, status: 'Available', phone: '+91 98765 43214', designation: 'Environmental Sanitation Lead', email: 'sunita.das@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-015', entry_id: 'OFF-015', username: 'alok.pandey', name: 'Alok Pandey', departmentKey: 'sanitation', departmentName: 'Sanitation & Waste Management', city: 'Nizamabad', area: 'Khaleelwadi', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 13, processedProjects: 15, status: 'Available', phone: '+91 98765 43215', designation: 'Commercial Waste Coordinator', email: 'alok.pandey@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'drainage',
    name: 'Drainage & Sewage',
    description: 'Drainage blockage, sewage overflows, stormwater culvert choking, open drains',
    coverage: ['Drainage Blockage', 'Sewage Overflow', 'Stormwater Manhole Clogs', 'Underground Gutter Choking'],
    officers: [
      { id: 'OFF-016', entry_id: 'OFF-016', username: 'sandeep.rao', name: 'Sandeep Rao', departmentKey: 'drainage', departmentName: 'Drainage & Sewage', city: 'Khammam', area: 'Rotary Nagar', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 14, processedProjects: 15, status: 'Available', phone: '+91 98765 43216', designation: 'Drainage Systems Engineer', email: 'sandeep.rao@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-017', entry_id: 'OFF-017', username: 'deepali.joshi', name: 'Deepali Joshi', departmentKey: 'drainage', departmentName: 'Drainage & Sewage', city: 'Guntur', area: 'Brodipet', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 16, processedProjects: 18, status: 'Available', phone: '+91 98765 43217', designation: 'Stormwater Sewerage Specialist', email: 'deepali.joshi@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-018', entry_id: 'OFF-018', username: 'vinod.kumar', name: 'Vinod Kumar', departmentKey: 'drainage', departmentName: 'Drainage & Sewage', city: 'Karimnagar', area: 'Mukarampura', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 22, processedProjects: 25, status: 'Available', phone: '+91 98765 43218', designation: 'Sewage Treatment Supervisor', email: 'vinod.kumar@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-019', entry_id: 'OFF-019', username: 'lakshmi.narayana', name: 'Lakshmi Narayana', departmentKey: 'drainage', departmentName: 'Drainage & Sewage', city: 'Kurnool', area: 'NR Peta', currentAssignments: 0, ongoingProjects: 0, pendingProjects: 0, solvedProjects: 9, processedProjects: 9, status: 'Available', phone: '+91 98765 43219', designation: 'Urban Drainage Inspector', email: 'lakshmi.narayana@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-020', entry_id: 'OFF-020', username: 'vikram.singh.drain', name: 'Vikram Singh', departmentKey: 'drainage', departmentName: 'Drainage & Sewage', city: 'Hyderabad', area: 'Kukatpally', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 21, processedProjects: 23, status: 'Available', phone: '+91 98765 43220', designation: 'Desilting & Jetting Squad Lead', email: 'vikram.singh@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'street_lighting',
    name: 'Street Lighting',
    description: 'Streetlights, dark streets, streetlight timer and circuit defects, flickering lamps',
    coverage: ['Dark Corridors & Outages', 'Damaged Streetlight Poles', 'Timer & Sensor Faults', 'Flickering Public Lights'],
    officers: [
      { id: 'OFF-021', entry_id: 'OFF-021', username: 'manoj.deshmukh', name: 'Manoj Deshmukh', departmentKey: 'street_lighting', departmentName: 'Street Lighting', city: 'Khammam', area: 'Trunk Road', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 29, processedProjects: 31, status: 'Available', phone: '+91 98765 43221', designation: 'Chief Lighting Inspector', email: 'manoj.deshmukh@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-022', entry_id: 'OFF-022', username: 'deepa.rao', name: 'Deepa Rao', departmentKey: 'street_lighting', departmentName: 'Street Lighting', city: 'Hyderabad', area: 'Hitec City', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 24, processedProjects: 25, status: 'Available', phone: '+91 98765 43222', designation: 'Smart Streetlight Grid Operator', email: 'deepa.rao@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-023', entry_id: 'OFF-023', username: 'arjun.patil', name: 'Arjun Patil', departmentKey: 'street_lighting', departmentName: 'Street Lighting', city: 'Warangal', area: 'Naimnagar', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 20, processedProjects: 23, status: 'Available', phone: '+91 98765 43223', designation: 'Public Illumination Field Lead', email: 'arjun.patil@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-024', entry_id: 'OFF-024', username: 'rohit.saxena', name: 'Rohit Saxena', departmentKey: 'street_lighting', departmentName: 'Street Lighting', city: 'Vijayawada', area: 'Labbipet', currentAssignments: 4, ongoingProjects: 2, pendingProjects: 2, solvedProjects: 28, processedProjects: 32, status: 'Available', phone: '+91 98765 43224', designation: 'LED Maintenance Supervisor', email: 'rohit.saxena@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-025', entry_id: 'OFF-025', username: 'ananya.sengupta', name: 'Ananya Sengupta', departmentKey: 'street_lighting', departmentName: 'Street Lighting', city: 'Visakhapatnam', area: 'Siripuram', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 16, processedProjects: 17, status: 'Available', phone: '+91 98765 43225', designation: 'Energy Efficiency & Lighting Lead', email: 'ananya.sengupta@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'public_health',
    name: 'Public Health',
    description: 'Mosquito breeding zones, stagnant water sanitation, fumigation requests, public hygiene',
    coverage: ['Mosquito Breeding Zones', 'Stagnant Water Sanitation', 'Fumigation Requests', 'Public Health Vector Control'],
    officers: [
      { id: 'OFF-026', entry_id: 'OFF-026', username: 'sunita.patel', name: 'Sunita Patel', departmentKey: 'public_health', departmentName: 'Public Health', city: 'Hyderabad', area: 'Secunderabad', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 26, processedProjects: 28, status: 'Available', phone: '+91 98765 43226', designation: 'Chief Public Health Officer', email: 'sunita.patel@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-027', entry_id: 'OFF-027', username: 'harish.joshi', name: 'Harish Joshi', departmentKey: 'public_health', departmentName: 'Public Health', city: 'Vijayawada', area: 'Moghalrajpuram', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 18, processedProjects: 19, status: 'Available', phone: '+91 98765 43227', designation: 'Vector Control & Fumigation Lead', email: 'harish.joshi@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-028', entry_id: 'OFF-028', username: 'divya.sundaram', name: 'Divya Sundaram', departmentKey: 'public_health', departmentName: 'Public Health', city: 'Visakhapatnam', area: 'Dwaraka Nagar', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 22, processedProjects: 24, status: 'Available', phone: '+91 98765 43228', designation: 'Community Hygiene Inspector', email: 'divya.sundaram@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-029', entry_id: 'OFF-029', username: 'gurpreet.singh', name: 'Gurpreet Singh', departmentKey: 'public_health', departmentName: 'Public Health', city: 'Khammam', area: 'Mamillagudem', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 20, processedProjects: 22, status: 'Available', phone: '+91 98765 43229', designation: 'Disease Prevention Field Marshal', email: 'gurpreet.singh@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-030', entry_id: 'OFF-030', username: 'balakrishna.reddy', name: 'Balakrishna Reddy', departmentKey: 'public_health', departmentName: 'Public Health', city: 'Tirupati', area: 'Bhavani Nagar', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 14, processedProjects: 15, status: 'Available', phone: '+91 98765 43230', designation: 'Epidemic Sanitation Coordinator', email: 'balakrishna.reddy@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'parks',
    name: 'Parks & Public Spaces',
    description: 'Broken play equipment, overgrown vegetation and weeds, park bench damage, public garden upkeep',
    coverage: ['Broken Play Equipment', 'Overgrown Vegetation & Weeds', 'Park Bench Damage', 'Public Garden Maintenance'],
    officers: [
      { id: 'OFF-031', entry_id: 'OFF-031', username: 'radhika.mohan', name: 'Radhika Mohan', departmentKey: 'parks', departmentName: 'Parks & Public Spaces', city: 'Hyderabad', area: 'Kondapur', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 18, processedProjects: 20, status: 'Available', phone: '+91 98765 43231', designation: 'Urban Horticulture Superintendent', email: 'radhika.mohan@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-032', entry_id: 'OFF-032', username: 'tariq.ahmed', name: 'Tariq Ahmed', departmentKey: 'parks', departmentName: 'Parks & Public Spaces', city: 'Khammam', area: 'NST Colony', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 16, processedProjects: 17, status: 'Available', phone: '+91 98765 43232', designation: 'Public Gardens & Playgrounds Lead', email: 'tariq.ahmed@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-033', entry_id: 'OFF-033', username: 'goutham.shinde', name: 'Goutham Shinde', departmentKey: 'parks', departmentName: 'Parks & Public Spaces', city: 'Kurnool', area: 'C-Camp', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 11, processedProjects: 12, status: 'Available', phone: '+91 98765 43233', designation: 'Park Infrastructure Inspector', email: 'goutham.shinde@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-034', entry_id: 'OFF-034', username: 'rekha.swaminathan', name: 'Rekha Swaminathan', departmentKey: 'parks', departmentName: 'Parks & Public Spaces', city: 'Warangal', area: 'Hanamkonda', currentAssignments: 0, ongoingProjects: 0, pendingProjects: 0, solvedProjects: 12, processedProjects: 12, status: 'Available', phone: '+91 98765 43234', designation: 'Green Belt Maintenance Supervisor', email: 'rekha.swaminathan@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-035', entry_id: 'OFF-035', username: 'bhaskar.raju', name: 'Bhaskar Raju', departmentKey: 'parks', departmentName: 'Parks & Public Spaces', city: 'Guntur', area: 'Pattabhipuram', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 19, processedProjects: 21, status: 'Available', phone: '+91 98765 43235', designation: 'Landscape & Public Spaces Marshal', email: 'bhaskar.raju@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'traffic',
    name: 'Traffic & Transportation',
    description: 'Faulty traffic signals, missing road signage, zebra crossings, speed breaker hazards',
    coverage: ['Faulty Traffic Signals', 'Missing Road Signage', 'Zebra Crossing Repainting', 'Blinkers & Speed Breaker Defects'],
    officers: [
      { id: 'OFF-036', entry_id: 'OFF-036', username: 'swati.kulkarni', name: 'Swati Kulkarni', departmentKey: 'traffic', departmentName: 'Traffic & Transportation', city: 'Hyderabad', area: 'Begumpet', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 22, processedProjects: 25, status: 'Available', phone: '+91 98765 43236', designation: 'Traffic Signals & Systems Engineer', email: 'swati.kulkarni@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-037', entry_id: 'OFF-037', username: 'nagesh.rao', name: 'Nagesh Rao', departmentKey: 'traffic', departmentName: 'Traffic & Transportation', city: 'Tirupati', area: 'Korlagunta', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 15, processedProjects: 16, status: 'Available', phone: '+91 98765 43237', designation: 'Road Signage & Markings Lead', email: 'nagesh.rao@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-038', entry_id: 'OFF-038', username: 'devendra.rathore', name: 'Devendra Rathore', departmentKey: 'traffic', departmentName: 'Traffic & Transportation', city: 'Khammam', area: 'Bypass Road', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 26, processedProjects: 28, status: 'Available', phone: '+91 98765 43238', designation: 'Urban Transit Infrastructure Lead', email: 'devendra.rathore@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-039', entry_id: 'OFF-039', username: 'shilpa.hegde', name: 'Shilpa Hegde', departmentKey: 'traffic', departmentName: 'Traffic & Transportation', city: 'Karimnagar', area: 'Collectorate Road', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 15, processedProjects: 16, status: 'Available', phone: '+91 98765 43239', designation: 'Junction Safety Auditor', email: 'shilpa.hegde@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-040', entry_id: 'OFF-040', username: 'pradeep.verma', name: 'Pradeep Verma', departmentKey: 'traffic', departmentName: 'Traffic & Transportation', city: 'Vijayawada', area: 'One Town', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 21, processedProjects: 23, status: 'Available', phone: '+91 98765 43240', designation: 'Speed Calming & Bollards Inspector', email: 'pradeep.verma@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'electricity',
    name: 'Electricity & Utilities',
    description: 'Transformer sparking, loose power cables, open junction boxes, electric utility hazards',
    coverage: ['Transformer Sparking', 'Hanging High-Tension Cables', 'Damaged Power Junction Boxes', 'Dangerous Electric Poles'],
    officers: [
      { id: 'OFF-041', entry_id: 'OFF-041', username: 'farhan.ali', name: 'Farhan Ali', departmentKey: 'electricity', departmentName: 'Electricity & Utilities', city: 'Hyderabad', area: 'Charminar Zone', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 36, processedProjects: 38, status: 'Available', phone: '+91 98765 43241', designation: 'Chief Electrical Distribution Engineer', email: 'farhan.ali@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-042', entry_id: 'OFF-042', username: 'meera.nambiar', name: 'Meera Nambiar', departmentKey: 'electricity', departmentName: 'Electricity & Utilities', city: 'Warangal', area: 'Police Head Quarters', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 23, processedProjects: 24, status: 'Available', phone: '+91 98765 43242', designation: 'High Voltage Grid Safety Specialist', email: 'meera.nambiar@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-043', entry_id: 'OFF-043', username: 'sanjay.choudhary', name: 'Sanjay Choudhary', departmentKey: 'electricity', departmentName: 'Electricity & Utilities', city: 'Vijayawada', area: 'Labbipet', currentAssignments: 3, ongoingProjects: 2, pendingProjects: 1, solvedProjects: 30, processedProjects: 33, status: 'Available', phone: '+91 98765 43243', designation: 'Transformer Emergency Response Lead', email: 'sanjay.choudhary@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-044', entry_id: 'OFF-044', username: 'neha.kulkarni', name: 'Neha Kulkarni', departmentKey: 'electricity', departmentName: 'Electricity & Utilities', city: 'Visakhapatnam', area: 'Beach Road', currentAssignments: 0, ongoingProjects: 0, pendingProjects: 0, solvedProjects: 17, processedProjects: 17, status: 'Available', phone: '+91 98765 43244', designation: 'Underground Cable Safety Inspector', email: 'neha.kulkarni@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-045', entry_id: 'OFF-045', username: 'kalyan.chakravarthy', name: 'Kalyan Chakravarthy', departmentKey: 'electricity', departmentName: 'Electricity & Utilities', city: 'Khammam', area: 'Collectorate Zone', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 22, processedProjects: 24, status: 'Available', phone: '+91 98765 43245', designation: 'Electrical Hazards Mitigation Lead', email: 'kalyan.chakravarthy@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  },
  {
    key: 'public_facilities',
    name: 'Public Facilities & Buildings',
    description: 'Damaged public toilets, municipal building cracks, bus shelter maintenance, community hall repairs',
    coverage: ['Damaged Public Toilets', 'Municipal Building Cracks', 'Bus Shelter Maintenance', 'Community Hall Repairs'],
    officers: [
      { id: 'OFF-046', entry_id: 'OFF-046', username: 'lavanya.devi', name: 'Lavanya Devi', departmentKey: 'public_facilities', departmentName: 'Public Facilities & Buildings', city: 'Tirupati', area: 'Air Bypass Road', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 19, processedProjects: 20, status: 'Available', phone: '+91 98765 43246', designation: 'Public Facilities Maintenance Lead', email: 'lavanya.devi@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-047', entry_id: 'OFF-047', username: 'harpreet.kaur', name: 'Harpreet Kaur', departmentKey: 'public_facilities', departmentName: 'Public Facilities & Buildings', city: 'Nizamabad', area: 'Dubba', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 18, processedProjects: 20, status: 'Available', phone: '+91 98765 43247', designation: 'Municipal Buildings Structural Inspector', email: 'harpreet.kaur@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-048', entry_id: 'OFF-048', username: 'ravinder.saxena', name: 'Ravinder Saxena', departmentKey: 'public_facilities', departmentName: 'Public Facilities & Buildings', city: 'Khammam', area: 'VDO Colony', currentAssignments: 1, ongoingProjects: 1, pendingProjects: 0, solvedProjects: 31, processedProjects: 32, status: 'Available', phone: '+91 98765 43248', designation: 'Public Asset Rehabilitation Officer', email: 'ravinder.saxena@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-049', entry_id: 'OFF-049', username: 'madhavi.latha', name: 'Madhavi Latha', departmentKey: 'public_facilities', departmentName: 'Public Facilities & Buildings', city: 'Guntur', area: 'Lakshmipuram', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 21, processedProjects: 23, status: 'Available', phone: '+91 98765 43249', designation: 'Civic Facilities Supervisor', email: 'madhavi.latha@civicmind.gov.in', is_active: true, pin: '2026' },
      { id: 'OFF-050', entry_id: 'OFF-050', username: 'chandrasekhar.varma', name: 'Chandrasekhar Varma', departmentKey: 'public_facilities', departmentName: 'Public Facilities & Buildings', city: 'Hyderabad', area: 'Secunderabad', currentAssignments: 2, ongoingProjects: 1, pendingProjects: 1, solvedProjects: 26, processedProjects: 28, status: 'Available', phone: '+91 98765 43250', designation: 'Urban Infrastructure Superintendent', email: 'chandrasekhar.varma@civicmind.gov.in', is_active: true, pin: '2026' }
    ]
  }
];
...
export function validateOfficerCredentials(
  emailOrIdOrUsername: string, 
  passwordOrPin?: string
): OfficerValidationResult {
  if (!emailOrIdOrUsername || !emailOrIdOrUsername.trim()) {
    return {
      isValid: false,
      officer: null,
      message: 'Officer email or Badge ID is required.'
    };
  }
  ...
  if (!passwordOrPin || !passwordOrPin.trim()) {
    return {
      isValid: false,
      officer: null,
      message: 'Officer password or PIN is required.'
    };
  }

  const cleanUser = emailOrIdOrUsername.trim().toLowerCase();
  const cleanPass = passwordOrPin.trim();
  const allOfficers = getAllOfficersList();

  // Find officer by email, ID, entry_id, username, or name
  const found = allOfficers.find(o => {
    const matchEmail = (o.email || '').toLowerCase() === cleanUser ||
                       `${(o.name || '').toLowerCase().replace(/\s+/g, '.')}@civicmind.gov.in` === cleanUser ||
                       `${(o.name || '').toLowerCase().replace(/\s+/g, '.')}@municipal.gov.in` === cleanUser;
    const matchId = (o.id || '').toLowerCase() === cleanUser || (o.entry_id || '').toLowerCase() === cleanUser;
    const matchUsername = (o.username || '').toLowerCase() === cleanUser;
    const matchName = (o.name || '').toLowerCase() === cleanUser;
    return matchEmail || matchId || matchUsername || matchName;
  });
  ...
  if (!found) {
    return {
      isValid: false,
      officer: null,
      message: 'Invalid officer credentials. Officer account not found in municipal registry.'
    };
  }
  ...
  if (found.is_active === false) {
    return {
      isValid: false,
      officer: null,
      message: 'This officer account is inactive. Please contact municipal administration.'
    };
  }

  // Validate Password / PIN
  const validPinsAndPasswords = [
    found.pin,
    found.password,
    '2026',
    'officer2026',
  ...
  const isPasswordValid = validPinsAndPasswords.some(
  ...
  if (!isPasswordValid) {
    return {
      isValid: false,
      officer: null,
      message: 'Invalid officer credentials. Incorrect password.'
    };
  }
...
export function getDepartmentSuggestionByCategory(category: string, title?: string, description?: string): CivicDepartmentInfo {
  ...
  if (text.includes('pothole') || text.includes('asphalt') || text.includes('footpath') || text.includes('pavement') || text.includes('crater') || text.includes('tar') || text.includes('road damage') || text.includes('bridge') || text.includes('median')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'roads') || CIVIC_DEPARTMENTS_CONFIG[0];
  }
  // 2. Water Supply
  if (text.includes('water supply') || text.includes('potable') || text.includes('drinking water') || text.includes('water pipe') || text.includes('pipeline') || text.includes('low pressure') || (text.includes('water') && !text.includes('drain') && !text.includes('sewage') && !text.includes('stagnant'))) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'water') || CIVIC_DEPARTMENTS_CONFIG[1];
  }
  // 3. Sanitation & Waste Management
  if (text.includes('garbage') || text.includes('waste') || text.includes('dump') || text.includes('sanitation') || text.includes('trash') || text.includes('litter') || text.includes('debris') || text.includes('dustbin')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'sanitation') || CIVIC_DEPARTMENTS_CONFIG[2];
  }
  // 4. Drainage & Sewage
  if (text.includes('drain') || text.includes('sewage') || text.includes('gutter') || text.includes('culvert') || text.includes('sewer') || text.includes('manhole') || text.includes('waterlogging') || text.includes('stormwater')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'drainage') || CIVIC_DEPARTMENTS_CONFIG[3];
  }
  // 5. Street Lighting
  if (text.includes('street light') || text.includes('streetlight') || text.includes('dark street') || text.includes('illumination') || text.includes('lamp') || text.includes('flickering') || text.includes('dark corridor')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'street_lighting') || CIVIC_DEPARTMENTS_CONFIG[4];
  }
  // 6. Public Health
  if (text.includes('mosquito') || text.includes('dengue') || text.includes('malaria') || text.includes('fumigation') || text.includes('hygiene') || text.includes('health') || text.includes('epidemic') || text.includes('stagnant water')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'public_health') || CIVIC_DEPARTMENTS_CONFIG[5];
  }
  // 7. Parks & Public Spaces
  if (text.includes('park') || text.includes('garden') || text.includes('playground') || text.includes('swing') || text.includes('slide') || text.includes('bench') || text.includes('lawn') || text.includes('tree') || text.includes('horticulture') || text.includes('greenery')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'parks') || CIVIC_DEPARTMENTS_CONFIG[6];
  }
  // 8. Traffic & Transportation
  if (text.includes('traffic') || text.includes('signal') || text.includes('zebra') || text.includes('speed breaker') || text.includes('signage') || text.includes('sign board') || text.includes('bollard') || text.includes('transit')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'traffic') || CIVIC_DEPARTMENTS_CONFIG[7];
  }
  // 9. Electricity & Utilities
  if (text.includes('transformer') || text.includes('spark') || text.includes('power cut') || text.includes('electric wire') || text.includes('electric cable') || text.includes('high tension') || text.includes('electric shock') || text.includes('electricity')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'electricity') || CIVIC_DEPARTMENTS_CONFIG[8];
  }
  // 10. Public Facilities & Buildings
  if (text.includes('public toilet') || text.includes('bus shelter') || text.includes('bus stop') || text.includes('building') || text.includes('community hall') || text.includes('complex') || text.includes('public facility') || text.includes('property damage')) {
    return CIVIC_DEPARTMENTS_CONFIG.find(d => d.key === 'public_facilities') || CIVIC_DEPARTMENTS_CONFIG[9];
  }
...
export function convertCivicCaseToDoc(caseItem: CivicCase): any {
  ...
  const cleanEmail = (caseItem.citizenEmail || '').toLowerCase().trim();
  const cleanUserId = caseItem.userId || caseItem.citizenId || 'CIT-GUEST';
  const cleanCitizenId = caseItem.citizenId || caseItem.userId || 'CIT-GUEST';
  
  return {
    complaint_number: caseItem.id,
    user_id: cleanUserId,
    userId: cleanUserId,
    citizenUid: cleanUserId,
    citizen_uid: cleanUserId,
    citizenId: cleanCitizenId,
    citizen_id: cleanCitizenId,
    citizen_name: caseItem.citizenName || 'Citizen',
    citizenName: caseItem.citizenName || 'Citizen',
    citizen_phone: caseItem.citizenPhone || '',
    citizenPhone: caseItem.citizenPhone || '',
    citizen_email: cleanEmail,
...
export async function createComplaintInDb(input: CreateComplaintInput): Promise<CivicCase> {
  // Strict 10 Supported Civic Locations Validation before persistence
  const locationValidation = validateCivicServiceLocation({
    cityName: input.cityName,
    areaName: input.areaName,
    colonyName: input.colonyName,
    formattedAddress: input.streetAddress,
    lat: input.latitude,
    lng: input.longitude
  });

  if (!locationValidation.isSupported) {
    throw new Error(
      locationValidation.errorMessage ||
      `Complaint cannot be submitted outside authorized civic service areas. CivicMind operates exclusively in: ${SUPPORTED_LOCATIONS_SUMMARY}.`
    );
  }
 ...
 */
export function getComplaintsByCitizenId(
  citizenId: string, 
  allCases: CivicCase[],
  ...
  const cleanUserId = (options?.userId || '').trim().toLowerCase();
  ...
  return allCases.filter(c => {
    ...
    // Match by Citizen ID or Firebase User UID
    if (cleanId && (cId === cleanId || cUserId === cleanId)) return true;
    if (cleanUserId && (cUserId === cleanUserId || cId === cleanUserId)) return true;

    // Match by Email
    if (cleanEmail && cEmail && cEmail === cleanEmail) return true;

    // Match by Phone (if 10+ digits)
    if (cleanPhone.length >= 10 && cPhone.length >= 10) {
...
export function canUserAccessComplaint(
  ...
  if (userRole === 'GOVERNMENT_ADMIN' || userRole === 'SYSTEM_ADMIN' || userRole === 'OWNER') {
    return true;
  }
  ...
  const cleanOwnerCitId = (complaint.citizenId || '').trim().toLowerCase();
  const cleanOwnerUserId = (complaint.userId || '').trim().toLowerCase();
  
  if (cleanUser && (cleanUser === cleanOwnerCitId || cleanUser === cleanOwnerUserId)) {
    return true;
  }

  if (userEmail && complaint.citizenEmail) {
    if (userEmail.trim().toLowerCase() === complaint.citizenEmail.trim().toLowerCase()) {
      return true;
    }
  }

  if (userPhone && complaint.citizenPhone) {
    const uPhone = userPhone.replace(/\D/g, '');
    const cPhone = complaint.citizenPhone.replace(/\D/g, '');
    if (uPhone.length >= 10 && cPhone.length >= 10) {
      if (uPhone === cPhone || uPhone.endsWith(cPhone) || cPhone.endsWith(uPhone)) {
        return true;
      }
    }
  }
