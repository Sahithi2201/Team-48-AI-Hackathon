        ...
        <div className="p-4 border-t border-slate-100 space-y-3">
          ...
          <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-full bg-slate-900 text-cyan-400 font-bold text-xs flex items-center justify-center">
                AD
              </div>
              <div className="text-left">
                <div className="text-xs font-bold text-slate-900">Municipal Admin</div>
                <div className="text-[10px] text-slate-500 font-medium">Operations Chief • Level 4</div>
              </div>
            </div>
