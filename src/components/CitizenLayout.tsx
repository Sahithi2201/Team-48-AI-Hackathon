...
export const CitizenLayout: React.FC<CitizenLayoutProps> = ({
  ...
  const navItems = [
    ...
    },
    {
      ...
      label: 'My Complaints',
      icon: FileText,
      active: currentView === 'citizen-case-details'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#F6F9FC] text-[#0F172A] flex flex-col md:flex-row">
      
      {/* 1. STICKY LEFT SIDEBAR (DESKTOP) */}
      <aside className="hidden md:flex flex-col w-64 lg:w-72 bg-white border-r border-slate-200/90 shrink-0 sticky top-0 h-screen z-30 justify-between">
        ...
        <div className="p-4 border-t border-slate-100 space-y-3">
          ...
          <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div className="text-left">
                ...
                <div className="text-[10px] text-slate-500 font-medium">Ward 12 • Verified</div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              title="Switch to Government Command Center"
            >
        ...
        <header className="sticky top-0 z-20 bg-white/95 backdrop-blur-md border-b border-slate-200/80 px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between shrink-0">
          ...
          <div className="hidden md:flex items-center gap-3">
            <span className="text-xs font-mono font-bold px-2.5 py-1 rounded-md bg-blue-50 text-blue-700 border border-blue-200">
              CITIZEN RESOLUTION INTERFACE
            </span>
            <span className="text-xs text-slate-500">
              Real-time synchronization with Municipal Central Dispatch
            </span>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 max-w-md w-full border border-slate-200 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-500 font-mono">Citizen ID: #CIT-98230</p>
                </div>
              </div>
              <button 
            ...
            <div className="space-y-2 text-xs">
              <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase">Primary Jurisdiction</span>
                <div className="font-bold text-slate-900">Ward 12 (Central Zone), MG Road Sector</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
                <span className="text-[10px] font-bold text-slate-400 uppercase">Civic Credibility Score</span>
                <div className="font-bold text-emerald-600">98% Verified Reports (6 Total Filed)</div>
              </div>
            </div>
