...
export const AI_AGENTS_LIST: AIAgentDefinition[] = [
  {
    id: 'agent-1',
    name: '01 Intake Agent',
    role: 'Natural Language Understanding + Complaint Extraction',
  ...
  {
    id: 'agent-3',
    name: '03 Duplicate Intelligence Agent',
    role: 'Semantic + spatial duplicate detection',
    iconName: 'CopyCheck',
    ...
    sampleDecision: 'Consolidated 8 duplicate reports within 200m radius. Prevented redundant duplicate work orders.',
  ...
  {
    id: 'agent-4',
    name: '04 Priority / Risk Agent',
    role: 'Public Impact + Severity + Vulnerability scoring',
  ...
  {
    id: 'agent-5',
    name: '05 Location & Routing Agent',
    role: 'Jurisdiction + Department Routing',
    iconName: 'GitMerge',
  ...
  {
    id: 'agent-6',
    name: '06 Officer Assignment / SLA Agent',
    role: 'Intelligent Officer Assignment + Deadline Monitoring',
    iconName: 'Clock',
    description: 'Assigns best-fit field officer based on real-time workload, expertise, and tracks countdown against citizen charter mandates.',
    defaultConfidence: 93,
    sampleDecision: 'Assigned to Ward Engineer Rajesh Kumar. Target SLA: 24.0 Hours. Projected completion: 8.5 Hours.',
    inputs: ['Department Officer Workload Roster', 'Department SLA Citizen Charter table', 'Historical turnaround averages'],
    outputs: ['Assigned Officer ID & Name', 'SLA countdown clock', 'Breach probability calculation'],
    model: 'Constraint Optimizer + Survival Regression',
    accuracyRate: '94.0%',
    latencyTarget: '< 80ms'
  },
  {
    id: 'agent-7',
    name: '07 Escalation Agent',
    role: 'Autonomous escalation and government notification',
    iconName: 'ArrowUpRight',
    description: 'Autonomously triggers progressive alerts to Junior Engineers, Executive Engineers, and Municipal Commissioners upon SLA delay or bottleneck triggers.',
    defaultConfidence: 99,
    sampleDecision: 'Pre-escalation warning triggered at 75% SLA threshold. Automated dashboard alert and escalation note sent to Section In-Charge.',
    inputs: ['SLA monitoring stream', 'Hierarchy escalation matrix (JE -> EE -> Commissioner)', 'Field Blockers Telemetry'],
  ...
  {
    id: 'agent-8',
    name: '08 Resolution Verification Agent',
    role: 'AI-based resolution verification',
    iconName: 'ShieldCheck',
    description: 'Validates before and after geo-tagged repair photos and officer work notes using optical segmentation to verify genuine physical resolution.',
    defaultConfidence: 98,
    sampleDecision: 'Computer Vision analysis confirmed pothole cavity filled flush with bitumen. Verification confidence 96%. Recommended for Government Approval.',
    inputs: ['Citizen before photo', 'Field squad completion after photo', 'Officer work update notes', 'GPS & timestamp EXIF validation'],
    outputs: ['Visual repair verification score', 'Quality certificate', 'Government approval recommendation'],
