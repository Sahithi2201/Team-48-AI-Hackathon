...
export const OfficerLoginPage: React.FC<OfficerLoginPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#F6F9FC] text-[#0F172A] flex flex-col justify-between relative bg-smart-grid select-none p-4 sm:p-6 lg:p-8">
      
      {/* Background Soft Glows */}
      <div className="absolute top-10 left-1/4 w-96 h-96 bg-blue-200/40 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-10 right-1/4 w-96 h-96 bg-cyan-100/50 rounded-full blur-3xl pointer-events-none -z-10" />
