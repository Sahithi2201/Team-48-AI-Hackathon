...
export const GovernmentLoginPage: React.FC<GovernmentLoginPageProps> = ({
  ...
  const [govId, setGovId] = useState('officer.admin@municipal.gov.in');
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#F6F9FC] text-[#0F172A] flex items-center justify-center p-4 sm:p-6 bg-smart-grid relative">
      ...
      <div className="absolute top-10 right-10 w-96 h-96 bg-blue-200/40 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-10 left-10 w-96 h-96 bg-slate-200/50 rounded-full blur-3xl pointer-events-none -z-10" />
