...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#F6F9FC] text-[#0F172A] flex flex-col justify-between relative bg-smart-grid select-none">
      
      {/* Soft Ambient Background Highlights */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-blue-200/40 rounded-full blur-3xl pointer-events-none -z-10" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-cyan-100/50 rounded-full blur-3xl pointer-events-none -z-10" />
